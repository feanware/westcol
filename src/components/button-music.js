...
import styles from "@/styles/button-music.module.css";
const ButtonMusic = () => {
  ...
  return (
    <div className={styles.music}>
      <audio
        src="/assets/audio/dejalo-que-fluya.mp3"
        autoPlay
        loop
        ref={audioRef}
        onCanPlay={() => setIsLoaded(true)}
      ></audio>
      <button onClick={togglePlayPause} className={styles.buttonMusicButton}>
        {isPlaying ? (
          <svg
